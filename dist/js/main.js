...
Header = (function(_super) {
  ...
  function Header() {
    ...
    this.templateVars = {
      home: {
        label: this.CD_CE().locale.get('header_logo_label'),
        url: this.CD_CE().BASE_URL + '/' + this.CD_CE().nav.sections.HOME
      },
      about: {
        label: this.CD_CE().locale.get('header_about_label'),
        url: this.CD_CE().BASE_URL + '/' + this.CD_CE().nav.sections.ABOUT,
        section: this.CD_CE().nav.sections.ABOUT
      },
      contribute: {
        label: this.CD_CE().locale.get('header_contribute_label'),
        url: this.CD_CE().BASE_URL + '/' + this.CD_CE().nav.sections.CONTRIBUTE,
        section: this.CD_CE().nav.sections.CONTRIBUTE
      },
  ...
  Header.prototype.onAreaChange = function(section) {
    ...
    } else if (section === this.CD_CE().nav.sections.DOODLES) {
    ...
    } else if (section === this.CD_CE().nav.sections.ABOUT) {
    ...
    } else if (section === this.CD_CE().nav.sections.CONTRIBUTE) {
  ...
  Header.prototype.getSectionColour = function(section, wordSection) {
    ...
    colour = (function() {
      switch (section) {
        ...
        case 'doodle-info':
          return 'red';
        case this.CD_CE().nav.sections.ABOUT:
          return 'white';
        case this.CD_CE().nav.sections.CONTRIBUTE:
          return 'white';
        case this.CD_CE().nav.sections.DOODLES:
  ...
  Header.prototype._getDoodleColourScheme = function() {
    var colour, doodle;
    doodle = this.CD_CE().appData.doodles.getDoodleByNavSection('current');
  ...
  Header.prototype.onInfoBtnClick = function(e) {
    e.preventDefault();
    if (this.CD_CE().nav.current.area !== this.CD_CE().nav.sections.DOODLES) {
      return;
    }
  ...
  Header.prototype.onKeyup = function(e) {
    if (e.keyCode === 27 && this.CD_CE().nav.current.area === this.CD_CE().nav.sections.DOODLES) {
      this.hideDoodleInfo();
    }
    return null;
  };
...
DoodlePageView = (function(_super) {
  ...
  DoodlePageView.prototype.setupNavLinks = function() {
    ...
    prevDoodle = this.CD_CE().appData.doodles.getPrevDoodle(this.model);
    nextDoodle = this.CD_CE().appData.doodles.getNextDoodle(this.model);
    if (prevDoodle) {
  ...
  DoodlePageView.prototype.getDoodle = function() {
    var doodle;
    doodle = this.CD_CE().appData.doodles.at(0);
    return doodle;
  };
  ...
  DoodlePageView.prototype.getDoodleInfoContent = function() {
    ...
    doodleInfoVars = {
      ...
      share_url: this.CD_CE().BASE_URL + '/' + this.model.get('shortlink'),
      share_url_text: this.CD_CE().BASE_URL.replace('http://', '') + '/' + this.model.get('shortlink')
    };
