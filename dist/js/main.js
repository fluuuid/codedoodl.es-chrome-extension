...
DoodlePageView = (function(_super) {
  ...
  DoodlePageView.prototype.showFrame = function(removeEvent) {
    ...
    this.$frame.one('load', this.showDoodle);
    return null;
  };

  DoodlePageView.prototype.showDoodle = function() {
